...
helpers do
  ...
  GUIDES_EDIT_URL = 'https://github.com/nqis/nqis.github.io/edit/build/'.freeze
  ...
  def guides_edit_article(source)
    ...
    %(<a href="#{ url }" target="_blank"><span class="icon icon-pencil" id="edit-guides-article" title="Make a suggestion"></span></a>)
  end
